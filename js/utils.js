 ...
 */
function drawRegularPoly(ctx, numPoints, position, radius)
{
	var points = [];
 ...
 * @return {Element}
 */
function drawHex(ctx, position, radius)
{
 ...
 * @param {Object} an object containing the keys 'h','s','v'
 ...
 */
function getLogistic (lowerAsymptote, upperAsymptote, growth, growthAsymptote, time)
{
